      ...
      <div class="bg-white p-4 rounded-lg shadow mb-6">
        <form @submit.prevent="applyFilters" class="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div>
            ...
            <input v-model="filters.search" type="text" placeholder="Search products..." class="w-full px-3 py-2 border border-gray-300 rounded-md">
          </div>
          <div>
          ...
          <div>
            ...
            <input v-model.number="filters.min_price" type="number" step="0.01" placeholder="0" class="w-full px-3 py-2 border border-gray-300 rounded-md">
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Max Price</label>
            <input v-model.number="filters.max_price" type="number" step="0.01" placeholder="1000" class="w-full px-3 py-2 border border-gray-300 rounded-md">
          </div>
        </form>
      </div>
